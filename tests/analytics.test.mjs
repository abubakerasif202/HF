...
test("loads the HF GA4 property globally even when deployment env is not configured", async () => {
  ...
  assert.match(layout, /process\.env\.NEXT_PUBLIC_GA_ID\s*\?\?\s*["']G-C1L7YK52TM["']/);
