...
export const services: ContentPage[] = [
  {
    ...
    description: "House removalists in Adelaide for homes, apartments and townhouses. Plan access, furniture protection, packing support and destination placement with HF Removals Adelaide.",
    intro:
    ...
    sections: [
      ...
      { title: "Protect, load and place", body: "Available protection includes moving blankets, shrink wrap, bubble wrap, mattress protection and side-table protective wrapping. Label destination rooms and identify priority items for the unload." },
    ],
